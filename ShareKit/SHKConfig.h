...
#import "apikey.h" //Last.fm private api key config file


// App Description
// These values are used by any service that shows 'shared from XYZ'

#define SHKMyAppName			@"Last.fm"
#define SHKMyAppURL				@"http://www.last.fm/"
...
#define SHKFacebookKey				FACEBOOK_KEY
#define SHKFacebookSecret			FACEBOOK_SECRET
...
#define SHKBitLyLogin				BITLY_KEY
#define SHKBitLyKey					BITLY_SECRET
